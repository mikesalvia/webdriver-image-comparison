...
function saveElement(methods, instanceData, folders, element, tag, saveElementOptions) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, addressBarShadowPadding, formatImageName, savePerInstance, toolBarShadowPadding, disableCSSAnimation, hideScrollBars, colorToBlack, resizeDimensions, hideElements, removeElements, beforeOptions, enrichedInstanceData, screenshot, elementRectangleOptions, rectangles, croppedBase64Image, afterOptions;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    colorToBlack = 'colorToBlack' in saveElementOptions.method
